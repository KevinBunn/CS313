    ...
    <div class="content">
      ...
      <div class="category-column">
        ...
        foreach($categories as $category) {
            ...
            echo '<div class="category"><div class="category-top"><div class="category-title">' . $category["name"] . '</div><a href="delete_category.php?project=' . $project_id . '&category=' . $category_id . '">X</a></div>';
